...
- Compatible with existing CSS/JS that expect anchors:
...
# Normalize collection names from Excel
...
# 1) Trim blank lines at the top/bottom
body = body.strip("\n")
# 2) Collapse runs of 2+ blank lines to exactly 1 blank line
#    (so newline_to_br will yield a single <br> gap instead of a large gap)
import re as _re
body = _re.sub(r"\n{3,}", "\n\n", body)
# --------------------------------------------------------
